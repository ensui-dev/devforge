...
class ArchitectureTest {
    ...
    private static final String[] MODULES = {"identity", "workspace", "document", "task", "instance", "audit", "sync"};
    ...
    void modulesTalkOnlyThroughPublishedContracts() {
        for (String module : MODULES) {
            ArchRule rule = noClasses()
                    ...
                    .and().resideInAPackage("com.devforge.(identity|workspace|document|task|instance|audit|sync)..")
