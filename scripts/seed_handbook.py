...
REFERENCES: list[tuple[str, str, str]] = [
    ...
    ("push-and-clone", "RELATED", "sync-from-git"),
    ("push-and-clone", "DEPENDS_ON", "tutorial-writing-documents"),
    ("push-and-clone", "DOCUMENTS", "roles-and-permissions"),
    ("push-and-clone", "RELATED", "self-hosting"),
    ("sync-from-git", "RELATED", "push-and-clone"),
